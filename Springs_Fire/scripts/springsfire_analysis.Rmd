...
export(prespringsfuels_complete_joined, "C:/Users/ashle/Documents/R/RX_Fire_Monitoring/RX_Fire_Monitoring/Springs_Fire/data/clean/prespringsfuels_complete.csv")


#plot

prespringsfuels_complete
     
            prespringsfuels_plot <- ggplot(data=prespringsfuels_complete_joined, mapping = aes(x=treatment_type, y=mass))+
              geom_boxplot()+
...
ggsave("C:/Users/ashle/Documents/R/RX_Fire_Monitoring/RX_Fire_Monitoring/Springs_Fire/images/prespringsfuels.png", prespringsfuels_plot)
...
export(postspringsfuels_complete_joined, "C:/Users/ashle/Documents/R/RX_Fire_Monitoring/RX_Fire_Monitoring/Springs_Fire/data/clean/postspringsfuels_complete.csv")

#plot
     

            
            postspringsfuels_plot <- ggplot(data=postspringsfuels_complete_joined, mapping = aes(x=treatment_type, y=mass))+
              geom_boxplot()+
              geom_jitter(alpha = 0.3)+
              facet_wrap(~ fuel_size, scales = "free_y") +
              xlab("Prior Treatment")+
            ...
            ggsave("C:/Users/ashle/Documents/R/RX_Fire_Monitoring/RX_Fire_Monitoring/Springs_Fire/images/postspringsfuels.png", postspringsfuels_plot)
...
springs_control <- springsfuels_total %>% 
  filter(treatment_type == 'control') %>% 
  filter(fuel_size == 'total_fuel') %>% 
  filter(time == 'postburn_mass')

springs_2013 <- springsfuels_total %>% 
  filter(treatment_type == '2013rx') %>% 
  filter(fuel_size == 'total_fuel') %>% 
  filter(time == 'postburn_mass') %>% 
  na.omit()

mean(springs_2013$mass) 
2.39-.62
